...
- PC版ではClipカードからモーダルウィンドウを開き、Twitch Clipをページ内で確認できます。SP版ではTwitchリンクとして開き、画面サイズと外部埋め込み負荷を避けます。中央操作は通常のリンクとして維持し、SP幅・修飾キー付きクリック・embed不可URLではブラウザ標準のリンク動作へ戻します。モーダル内のiframeはクリック時にだけ生成し、閉じるとiframeを破棄して再生と通信を止めます。
